...
\begin{align*}
  ...
  &\quad \opn{DE}\left(\psi\middle|0,\omega_{0}\right)\left\{\prod_{i=1}^{n}\left(1\left[y_{i}^{*}\geq 0\right]1\left[y_{i}=1\right] + 1\left[y_{i}^{*}<0\right]1\left[y_{i}=0\right] \right) \right\}\phi\left(y_{i}^{*}-w_{i}^{\top}\beta - \varphi_{i}^{\top}\theta_{J}\right)
\end{align*}
