...
%   &\quad + \textcolor{myorange}{\delta^{2}}\left(3\Tr\left(\varphi_{J}^{a}\left(x_{i}\right)\Sigma_{\theta}^{q}\right)^{2} + 6{\mu_{\theta}^{q}}'\varphi_{J}^{a}\left(x_{i}\right)\Sigma_{\theta}^{q}\varphi_{J}^{a}\left(x_{i}\right)\mu_{\theta}^{q} + \left({\mu_{\theta}^{q}}'\varphi_{J}^{a}\left(x_{i}\right)\mu_{\theta}\right)^{2} \right)
% \end{align*}
% Note the orange color delta that is missing in the original paper. Arranging the terms,
% \begin{align*}
%   S_{2}\left(\mu_{\theta}^{q}, \Sigma_{\theta}^{q}\right) &= -\frac{1}{2}\opn{E}\left(\frac{1}{\sigma^{2}}\right)\sum_{i=1}^{n} \left(y_{i} -w_{i}'\mu_{\beta}^{q}-\delta\left(\Tr\left(\varphi_{J}^{a}\left(x_{i}\right)\Sigma_{\theta}^{q}\right)+{\mu_{\theta}^{q}}'\varphi_{J}^{a}\left(x_{i}\right)\mu_{\theta}^{q}\right)\right)^{2}\\
%   &\qquad + \textcolor{myorange}{\delta^{2}}\left(2\Tr\left(\varphi_{J}^{a}\left(x_{i}\right)\Sigma_{\theta}^{q}\right)^{2}+4{\mu_{\theta}^{q}}'\varphi_{J}^{a}\left(x_{i}\right)\Sigma_{\theta}^{q}\varphi_{J}^{a}\left(x_{i}\right)\mu_{\theta}^{q}\right) + \Tr\left(w_{i}w'_{i}\Sigma_{\beta}^{q}\right).
% \end{align*}
% \subsubsection{Probit model}
% $S_{2}\left(\mu_{\theta}^{q}, \Sigma_{\theta}^{q}\right) = \opn{E}\left(\ln p\left(y^{*}|\beta, \theta_{J}, \sigma^{2}\right)\right)$.
% \begin{align*}
%   S_{2}\left(\mu_{\theta}^{q}, \Sigma_{\theta}^{q}\right) &= -\frac{1}{2}\opn{E}\left(\frac{1}{\sigma^{2}}\right)\sum_{i=1}^{n} \left(\mu_{y_{i}}^{q} -w_{i}'\mu_{\beta}^{q}-\delta\left(\Tr\left(\varphi_{J}^{a}\left(x_{i}\right)\Sigma_{\theta}^{q}\right)+{\mu_{\theta}^{q}}'\varphi_{J}^{a}\left(x_{i}\right)\mu_{\theta}^{q}\right)\right)^{2}\\
%   &\qquad + \delta^{2}\left(2\Tr\left(\varphi_{J}^{a}\left(x_{i}\right)\Sigma_{\theta}^{q}\right)^{2}+4{\mu_{\theta}^{q}}'\varphi_{J}^{a}\left(x_{i}\right)\Sigma_{\theta}^{q}\varphi_{J}^{a}\left(x_{i}\right)\mu_{\theta}^{q}\right) + \Tr\left(w_{i}w'_{i}\Sigma_{\beta}^{q}\right)
% \end{align*}
% Therefore, the derivative is as follows.
% \begin{align*}
%   \frac{\partial S_{2}}{\partial \Sigma_{\theta}^{q}} &= -\frac{1}{2}\opn{E}\left(\frac{1}{\sigma^{2}}\right)\sum_{i=1}^{n}\delta^{2}\left(4\varphi_{J}^{a}\left(x_{i}\right)\Sigma_{\theta}^{q}\varphi_{J}^{a}\left(x_{i}\right)+4\varphi_{J}^{a}\left(x_{i}\right)\mu_{\theta}^{q}{\mu_{\theta}^{q}}'\varphi_{J}^{a}\left(x_{i}\right)\right)\\
%   &\qquad -2\delta\left(\mu_{y_{i}^{*}}^{q}-w'_{i}\mu_{\beta}^{q}-\delta\Tr\left(\varphi_{J}^{a}\left(x_{i}\right)\Sigma_{\theta}^{q}\right) -\delta{\mu_{\theta}^{q}}'\Sigma_{\theta}^{q}\mu_{\theta}^{q}\right)\varphi_{J}^{a}\left(x_{i}\right)
% \end{align*}
