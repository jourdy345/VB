...
dat=gen.data(nsim,n,f1,sig=1,seed=1,equal=TRUE) # data generation


comp.time=lmarg=rmse=rmise=matrix(0,nr=nsim,nc=5)
colnames(comp.time)=colnames(lmarg)=colnames(rmse)=colnames(rmise)=c('VBU','VBM','VBM(NEW)','BSAR','BSARM')
